...
from  account.serializers import UserModelSerializer,UserLoginSerializer,UserProfileSerializer,UserpasswordChangeSerializer
...
class UserChangePasswordView(APIView):
    ...
    def post(self,request,format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            return Response({'mgs':'Password Change Succesfully'},status=status.HTTP_200_OK)
        return Response(serializer.errors,status=status.HTTP_400_BAD_REQUEST)
